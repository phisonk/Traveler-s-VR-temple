...
public class MainScript : MonoBehaviour {
	...
	{
		RestClient.Get<returnData>(basePath+"/decreaseAmount?name=phison&amount=-100").Then(res =>
		{
	...
	public void Get(){
		...
		RestClient.Get<walletAmount>("https://vr-traveler-back.web.app/amount?name=phison").Then(res => {
			this.LogMessage("Success", JsonUtility.ToJson(res, true));
			//EditorUtility.DisplayDialog("Response", res.args, "Ok");
			print(res.amount);
